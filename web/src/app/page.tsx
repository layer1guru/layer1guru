            ...
            <Container className="mt-9">
                <div className="max-w-2xl">
                    <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
                        Learn to Design, Launch &amp; Manage <span className="italic text-sky-400">LIMITLESS</span> L1s — let&apos;s realize your <span className="italic text-fuchsia-400">WILDEST</span> dreams!
                    </h1>
