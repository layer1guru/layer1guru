...
export const answer = {
    author: 'Shomari',
    date: '2024-11-24',
    title: 'What are the minimum steps for deploying a new Layer-1 blockchain?',
    description:
        'In under 15 minutes you will be up and running with a Layer-1 blockchain, fully operational to your local node.',
}
...
export default (props) => <ArticleLayout answer={answer} {...props} />
