...
export const article = {
  author: 'Shomari',
  date: '2024-11-24',
  title: 'Layer1 Node Runner',
  description:
    'A comprehensive suite of tools and services for Layer1 pioneers.',
}
...
export default (props) => <AnswerLayout article={article} {...props} />

Node Runner offers a comprehensive suite of tools and services for Layer1 pioneers.
