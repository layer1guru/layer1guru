...
const projects = [
    ...
    },
    {
        ...
        link: { href: '/showcase/mul8', label: 'mul8.gg' },
...
export default function Showcase() {
    return (
        <SimpleLayout
            ...
            intro="Over the last few decades, I’ve worked on tons of little projects, but these are the ones that matured with enough Product-Market-Fit (PMF) for an independent and economically sustainable Layer1 network.
            ALL Virtual Machines (VMs) are Free and Open-source Software (FOSS) — check out the code and contribute if you have ideas for how they can be improved."
        >
            <ul
                role="list"
